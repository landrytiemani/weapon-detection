# """
# Minimal analysis utilities for model summary.
# """

# def get_model_summary(model, input_size=(640, 640), device='cpu'):
#     """
#     Get a basic summary of the model.
...
===========================================================
CORRECTED VERSION - Removed duplicate get_model_summary() function (was on lines 5-34 AND 36-65)

Added:
- GFLOPs measurement using thop library
- Memory footprint estimation
- Inference time measurement

Hardware Target: NVIDIA A100 vGPU (GRID A100X-20C, 20GB VRAM)
"""
